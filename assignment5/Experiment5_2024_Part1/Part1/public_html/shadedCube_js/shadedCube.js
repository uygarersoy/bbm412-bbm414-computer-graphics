...
document.getElementById("ButtonYPlus").onclick = function() {
    lightPosition = vec4(0.0, 1.0, 0.0, 0.0);
    updateLighting();
};

document.getElementById("ButtonYMinus").onclick = function() {
    lightPosition = vec4(0.0, -1.0, 0.0, 0.0);
    updateLighting();
};

document.getElementById("ButtonZPlus").onclick = function() {
    lightPosition = vec4(0.0, 0.0, 1.0, 0.0);
    updateLighting();
};

document.getElementById("ButtonZMinus").onclick = function() {
    lightPosition = vec4(0.0, 0.0, -1.0, 0.0);
    updateLighting();
};
